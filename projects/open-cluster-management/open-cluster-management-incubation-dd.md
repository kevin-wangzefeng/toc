...
- [ ] **Complete a [General Technical Review (GTR)](../toc_subprojects/project-reviews-subproject/general-technical-questions.md).**
  - This was most recently revised on DD-MMM-YYYY. The snapshot is available in this repo at `projects/open-cluster-management/tech-review/YYYY-MM-DD.md` ($LINK).
